...
const es: Translation = {
  ...
  tools: {
    ...
    cookieHint: "Solo podemos leer cookies y almacenamiento del dominio actual.",
    cookieTrackers: "{n} posibles rastreadores",
    none: "Vacío",
    entries: "entradas",
    file: "Archivo",
    ...
    socialHint: "Toca cada control para marcarlo como cumplido y mejorar tu puntuación.",
    socialEmpty: "Selecciona una red para empezar.",
    done: "Listo",
    todo: "Pendiente",
    socialChecks: {
    ...
    metadataDrop: "Arrastra o selecciona un PDF/DOCX/PPTX",
    metadataHint: "Inspeccionamos autor, fechas y otros campos visibles (no podemos leer archivos cifrados).",
    metadataCleaned: "Se creó una copia sin metadatos visibles.",
    ...
    consentNote: "Configura qué categorías ofrecerás. Copia el snippet para integrarlo en tu sitio.",
    consentPreview: "Snippet listo para pegar",
    messagingTitle: "Comparador de Cifrado de Mensajería",
    messagingColumns: { app: "App", encryption: "Cifrado", backups: "Respaldo", metadata: "Metadatos", notes: "Notas" },
    messagingApps: [
      { name: "Signal", encryption: "Cifrado extremo a extremo por defecto", backups: "Respaldos locales cifrados", metadata: "Metadatos mínimos", note: "Máxima privacidad: sin metadatos y E2E completo." },
      { name: "WhatsApp", encryption: "Chats cifrados punto a punto", backups: "Copias en la nube opcionales", metadata: "Contactos + metadatos", note: "Usa E2E, pero las copias en la nube y metadatos exponen." },
      { name: "Telegram", encryption: "Cifrado opcional (Secret Chats)", backups: "Respaldos en la nube", metadata: "Metadatos en servidores", note: "Los chats cloud no son E2E; usa Secret Chats." },
      { name: "iMessage", encryption: "Extremo a extremo entre dispositivos Apple", backups: "iCloud (llaves pueden almacenarse)", metadata: "Metadatos de Apple", note: "Seguro entre dispositivos Apple; atención a iCloud." },
      { name: "RCS", encryption: "Depende del operador/cliente", backups: "Operador/Google", metadata: "Metadatos de operador", note: "Depende del cliente/operador: no siempre cifrado extremo a extremo." }
    ],
    ...
    fingerprintHint: "Escaneamos red, gráficos, WebGL, canvas y fuentes locales para calcular tu huella.",
    fingerprintEmpty: "Pulsa analizar para cargar datos reales de tu navegador.",
    perms: {
      mic: "Micrófono",
      location: "Ubicación",
...
const en: Translation = {
  ...
  tools: {
    ...
    clear: "Clear",
    lastScan: "Last scan:",
    cookieHint: "We can only read cookies and storage for this domain.",
    cookieTrackers: "{n} potential trackers",
    none: "Empty",
    entries: "entries",
    file: "File",
    ...
    socialHint: "Tap each control to mark it done and raise your score.",
    socialEmpty: "Choose a network to get started.",
    done: "Done",
    todo: "Pending",
    socialChecks: {
    ...
    metadataDrop: "Drop or select a PDF/DOCX/PPTX",
    metadataHint: "We check visible fields like author, creation date, and producer (encrypted files stay private).",
    metadataCleaned: "A scrubbed copy is ready without visible metadata.",
    ...
    consentMarketing: "Marketing",
    consentNote: "Choose the categories you will offer. Copy the snippet to embed it.",
    consentPreview: "Snippet ready to paste",
    messagingTitle: "Messaging Encryption Comparator",
    messagingColumns: { app: "App", encryption: "Encryption", backups: "Backups", metadata: "Metadata", notes: "Notes" },
    messagingApps: [
      { name: "Signal", encryption: "End-to-end by default", backups: "Encrypted local backups", metadata: "Minimal metadata", note: "Maximum privacy: minimal metadata and full E2E." },
      { name: "WhatsApp", encryption: "End-to-end chats", backups: "Cloud backups (optional)", metadata: "Contacts + metadata", note: "Uses E2E, but cloud backups and metadata leak info." },
      { name: "Telegram", encryption: "Optional (Secret Chats)", backups: "Cloud backups", metadata: "Server-side metadata", note: "Cloud chats are not E2E; use Secret Chats." },
      { name: "iMessage", encryption: "End-to-end across Apple devices", backups: "iCloud (keys may be stored)", metadata: "Apple metadata", note: "Secure across Apple devices; watch iCloud keys." },
      { name: "RCS", encryption: "Depends on carrier/client", backups: "Carrier/Google", metadata: "Carrier metadata", note: "Depends on client/carrier: not always end-to-end encrypted." }
    ],
    ...
    fingerprintHint: "We sample network, graphics, WebGL, canvas, and local fonts to build your fingerprint.",
    fingerprintEmpty: "Press analyze to load real data from your browser.",
