...
const es: Translation = {
  ...
  hardening: {
    ...
    checklist: {
        windows: [
            { id: 'w1', title: 'Desactivar Telemetría', description: 'Ve a Configuración > Privacidad > Comentarios y diagnósticos y selecciona "Básico".', impact: 'Alto' },
            { id: 'w2', title: 'Activar BitLocker', description: 'Cifra tu disco para proteger datos en caso de robo.', impact: 'Alto' },
            { id: 'w3', title: 'Control de Cuentas (UAC)', description: 'Configura UAC a "Notificarme siempre".', impact: 'Medio' },
            { id: 'w4', title: 'Eliminar Bloatware', description: 'Desinstala apps preinstaladas (Candy Crush, etc).', impact: 'Bajo' },
            { id: 'w5', title: 'DNS Privado', description: 'Configura DNS sobre HTTPS (DoH) en Red.', impact: 'Medio' },
            { id: 'w6', title: 'Desactivar ID Publicidad', description: 'Privacidad > General > ID de publicidad -> NO.', impact: 'Medio' },
            { id: 'w7', title: 'Historial Portapapeles', description: 'Desactivar si no se usa para evitar fugas.', impact: 'Bajo' }
        ],
        linux: [
            { id: 'l1', title: 'Cifrado de Disco', description: 'Asegura que LUKS esté activo.', impact: 'Alto' },
            { id: 'l2', title: 'Cortafuegos (UFW)', description: 'Activa UFW: `sudo ufw enable`.', impact: 'Alto' },
            { id: 'l3', title: 'Desactivar Root Login', description: 'Bloquea cuenta root: `sudo passwd -l root`.', impact: 'Medio' },
            { id: 'l4', title: 'AppArmor / SELinux', description: 'Asegura que MAC esté en modo enforcing.', impact: 'Alto' },
            { id: 'l5', title: 'Secure Boot', description: 'Activa Secure Boot en la BIOS.', impact: 'Medio' },
            { id: 'l6', title: 'Sandboxing', description: 'Prefiere Flatpak con Flatseal para permisos.', impact: 'Medio' }
        ],
        macos: [
            { id: 'm1', title: 'FileVault', description: 'Activa FileVault para cifrado de disco.', impact: 'Alto' },
            { id: 'm2', title: 'Cortafuegos', description: 'Ajustes > Red > Cortafuegos -> Activado.', impact: 'Medio' },
            { id: 'm3', title: 'Modo de Aislamiento', description: 'Activar si estás en alto riesgo (limita funciones).', impact: 'Alto' },
            { id: 'm4', title: 'Limitar Rastreo', description: 'Privacidad > Publicidad de Apple -> No.', impact: 'Bajo' },
            { id: 'm5', title: 'Desactivar Análisis', description: 'Privacidad > Análisis y mejoras -> No.', impact: 'Medio' }
        ],
        android: [
            { id: 'a1', title: 'Eliminar Bloatware', description: 'Deshabilita apps de operadora/fabricante.', impact: 'Medio' },
            { id: 'a2', title: 'Gestor de Permisos', description: 'Revisa Ubicación, Micrófono y Cámara.', impact: 'Alto' },
            { id: 'a3', title: 'F-Droid', description: 'Usa apps de código abierto cuando sea posible.', impact: 'Medio' },
            { id: 'a4', title: 'Backup Cifrado', description: 'Usa Seedvault o backups cifrados.', impact: 'Alto' },
            { id: 'a5', title: 'Desactivar Diagnóstico', description: 'Ajustes > Google > Uso y diagnóstico -> No.', impact: 'Bajo' }
        ],
        ios: [
            { id: 'i1', title: 'Protección Avanzada', description: 'Activa cifrado E2E para iCloud.', impact: 'Alto' },
            { id: 'i2', title: 'Rastreo de Apps', description: 'Pide a las apps no rastrear.', impact: 'Medio' },
            { id: 'i3', title: 'Modo de Aislamiento', description: 'Para protección extrema.', impact: 'Alto' },
            { id: 'i4', title: 'Comprobación Seguridad', description: 'Revisa quién tiene acceso a tus datos.', impact: 'Medio' },
            { id: 'i5', title: 'Ubicaciones Importantes', description: 'Privacidad > Localización > Sistema > Ubicaciones importantes -> No.', impact: 'Medio' }
        ]
    }
  },
  tempMail: {
