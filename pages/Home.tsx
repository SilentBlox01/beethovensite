...
export const Home: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <section className="py-12 bg-slate-50 dark:bg-slate-900/50 border-y border-slate-200 dark:border-slate-800 transition-colors duration-300">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 mb-4 text-amber-500 font-bold uppercase tracking-widest text-xs">
            <ShieldCheck size={16} /> {t.home.securityTipTitle}
          </div>
          <p className="text-xl md:text-2xl font-medium text-slate-700 dark:text-slate-300 italic">
            "{t.home.securityTips[Math.floor(Math.random() * t.home.securityTips.length)]}"
          </p>
        </div>
      </section>
